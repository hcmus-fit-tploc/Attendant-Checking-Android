...
public class ListAbsenStudentCurrentSessionImageFragment extends Fragment {
    ...
    public ListAbsenStudentCurrentSessionImageFragment(){}
    ...
    public void setListViewAdapter(){
        ...
        list = db.getStudentByAttendanceStatus(((CurrentSessionImageActivity)this.getActivity()).getAttendanceID(), AppVariable.ABSENCE_STATUS);

        listView.setAdapter(new ListAbsenStudentCurrentSessionImageAdapter(list, getActivity(), class_id, course_id, socket));
    }
