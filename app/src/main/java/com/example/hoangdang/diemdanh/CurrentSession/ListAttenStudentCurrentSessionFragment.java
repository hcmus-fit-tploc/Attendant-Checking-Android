...
public class ListAttenStudentCurrentSessionFragment extends Fragment {
    ...
    public ListAttenStudentCurrentSessionFragment(){}
    ...
    public void setListViewAdapter(){
        ...
        list = db.getStudentByAttendanceStatus(((CurrentSessionActivity)this.getActivity()).getAttendanceID(), AppVariable.ATTENDANCE_STATUS);

        listView.setAdapter(new ListAttenStudentCurrentSessionAdapter(list, getActivity(), class_id, course_id, socket));
    }
