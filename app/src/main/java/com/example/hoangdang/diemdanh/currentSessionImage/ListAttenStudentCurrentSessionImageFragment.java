...
public class ListAttenStudentCurrentSessionImageFragment extends Fragment {
    @BindView(R.id.current_session_image_listView)
    GridView listView;
    ...
    public ListAttenStudentCurrentSessionImageFragment(){}
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        socket = ((CurrentSessionImageActivity)this.getActivity()).getSocket();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_list_student_current_session_image, container,false);
    ...
    public void setListViewAdapter(){
        ...
        list = db.getStudentByAttendanceStatus(((CurrentSessionImageActivity)this.getActivity()).getAttendanceID(), AppVariable.ATTENDANCE_STATUS);

        listView.setAdapter(new ListAttenStudentCurrentSessionImageAdapter(list, getActivity(), class_id, course_id, socket));
    }
