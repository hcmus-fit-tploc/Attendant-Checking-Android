...
public class ListAbsenStudentCurrentSessionAdapter extends BaseAdapter implements ListAdapter {
    ...
    public ListAbsenStudentCurrentSessionAdapter(ArrayList<Student> list, Context context, int class_id, int course_id, Socket socket){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if( view == null){
            ...
            view = inflater.inflate(R.layout.custom_absen_student_current_session, null);
        }
        ...
        _changeButton = (Button)view.findViewById(R.id.atten_button);
        _changeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Hiep2","Is it changing status" + attendance_id + " " + student_id);
